...
if(${STRATA_TARGET_PLATFORM} STREQUAL Windows)
    ...
    elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        # On Windows Clang tries to emulate MSVC albeit with some differences, which are handled here.

        set(LIBUSB_PLATFORM_CONFIG_DIR "${LIBUSB_CONFIG_DIR}/msvc")

        # The UNREFERENCED_PARAMETER macro provided by the Windows SDK works fine with MSVC but leads
        # to unsued value warnings with Clang.
        # Since this macro is used by libusb we turn the warning off.
        #
        # Also there are pragma-pack warnings of valid code which we also turn off.
        target_compile_options(libusb_strata PRIVATE -Wno-pragma-pack -Wno-unused-value)
    else()
...
elseif(${STRATA_TARGET_PLATFORM} STREQUAL Macos)
    ...
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        # Clang finds more unused variables.
        # E.g. when a variable is only used in an assert that is then not part of the release build.
        # Thus turn this kind of warning off.
        target_compile_options(libusb_strata PRIVATE -Wno-unused-but-set-variable)
    endif()
